...
ndim=3;
%Value of "k". The "D_k" value that is evaluated
k=5;
...
chdim=1;
[drvA,drvB,drvC,drv_anltc_A,drv_anltc_B,drv_anltc_C]=d_k_derv_anltc_numeric(chdim,N,Q,j,k,L,varphi,del,nlim);
...
% chdim=3;
% [drvA(chdim),drvB(chdim),drvC(chdim),drv_anltc_A(chdim,:),drv_anltc_B(chdim,:),drv_anltc_C(chdim,:)]=d_k_derv_anltc_numeric(chdim,N,Q,j,k,L,varphi,del,nlim);
